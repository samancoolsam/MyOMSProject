...
public class ResourceUtil {
	...
	public static void loadDefaultResources() {
		...
		loadResourceFile("/resources/extn/ACADEMYServerError.properties");
				
		//client side configuration files
		loadResourceFile("ACADEMYPCA.properties");
		loadResourceFile("ACADEMYPCAError.properties");
		loadResourceFile("ACADEMYPCABundle.properties");
		loadMsgCodes("ACADEMYPCAError");
	...
	public static String get(String name, String defaultValue) {
		String retval = ResourceUtil.nonNull(resources.getProperty(name));
		if (retval.equals(""))
			retval = defaultValue;
		return retval.trim();
	}

	private static String nonNull(String property) {
