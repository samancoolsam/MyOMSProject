...
<tr>
	...
	<td class=tablecolumnheader sortable="yes" style="width:<%=getUITableSize("xml:/Shipment/ShipmentLines/ShipmentLine/@SegmentType")%>">
	<yfc:i18n>Segment_Type</yfc:i18n>
	</td>
	<td class=tablecolumnheader sortable="yes" style="width:<%=getUITableSize("xml:/Shipment/ShipmentLines/ShipmentLine/@Segment")%>">
...
<%	String orderHeaderKey = resolveValue("xml:/ShipmentLine/@OrderHeaderKey");
	...
	<!--   <td class="numerictablecolumn">
      ...
      <!-- <td class="numerictablecolumn">
	   ...
	   <td class="tablecolumn">
            <yfc:getXMLValue  name="ShipmentLine" binding="xml:/ShipmentLine/@SegmentType"/>
	   </td>
       <td class="tablecolumn">
            <yfc:getXMLValue  name="ShipmentLine" binding="xml:/ShipmentLine/@Segment"/>
	   </td>
       <td class="numerictablecolumn">
		<%if (isModificationAllowedWithModType("SHIPMENT_ADD_LINE", "xml:/Shipment/AllowedModifications") && isModificationAllowedWithModType("SHIPMENT_REMOVE_LINE", "xml:/Shipment/AllowedModifications") ) {%> 
...
<%				}	%>
				...
				<td class="tablecolumn">
					<%if(!bOrderAvailableOnSystemLineLevel){%>
					<input type="text" OldValue="" class="protectedinput" value="MTO"  <%=getTextOptions("xml:/Shipment/ShipmentLines/ShipmentLine_" + ShipmentLineCounter +"/@SegmentType","xml:/ShipmentLine/@SegmentType")%> style='width:60px'/> 
					<%}%>
				</td>
				<td class="tablecolumn">
					<%if(!bOrderAvailableOnSystemLineLevel){%>
					<input type="text" OldValue="" class="unprotectedinput"  <%=getTextOptions("xml:/Shipment/ShipmentLines/ShipmentLine_" + ShipmentLineCounter +"/@Segment","xml:/ShipmentLine/@Segment")%> style='width:60px'/> 
					<%}%>
				</td>
				<!--<td class="tablecolumn" >
				</td>-->
...
<%			}	%>
        ...
        <td class="tablecolumn">
			<%if(!bOrderAvailableOnSystem){%>
			<input type="text" class="protectedinput" value="MTO" <%=getTextOptions("xml:/Shipment/ShipmentLines/ShipmentLine_/@SegmentType")%>	style='width:60px'/> 
			<%}%>

		</td>
		 <td class="tablecolumn">
			<%if(!bOrderAvailableOnSystem){%>
			<input type="text" class="unprotectedinput"  <%=getTextOptions("xml:/Shipment/ShipmentLines/ShipmentLine_/@Segment")%>	style='width:60px'/> 
			<%}%>
