...
<jsp:include page="/yfsjspcommon/common_fields.jsp" flush="true">
    ...
    <tr>
		...
		<input type="hidden" name="xml:/Shipment/@DocumentType"  value='0006' />
		</td>
	    <td class="detaillabel" nowrap="true" > 
			<yfc:i18n><%=sOtherNodeLabel%></yfc:i18n> 
		</td>
    	<td class="searchcriteriacell"  nowrap="true">
		    <input type="text" class="protectedinput" value="701" <%=getTextOptions(sOtherNodeBinding)%> />
   ...
   <tr>
		...
		<td class="searchcriteriacell" nowrap="true" >
			<input type="text" class="protectedinput" value="Academy_Direct" <%=getTextOptions("xml:/Shipment/@SellerOrganizationCode")%> />
    ...
    <tr>
		...
		<!--<select name="xml:/Shipment/ScacAndService/@ScacAndServiceKey" class="combobox">
			<yfc:loopOptions binding="xml:/ScacAndServiceList/ScacAndService/@ScacAndService" name="ScacAndServiceDesc" value="ScacAndServiceKey" selected="xml:/ScacAndServiceList/ScacAndService/@ScacAndServiceKey" isLocalized="Y"/>
		</select>-->
		<input type="text" name="xml:/Shipment/ScacAndService/@ScacAndService" class="protectedinput"  <%=getTextOptions("xml:/ScacAndServiceList/ScacAndService/@ScacAndService")%> />
		<input type="hidden" name="xml:/Shipment/ScacAndService/@ScacAndServiceKey"  value='<%=resolveValue("xml:/ScacAndServiceList/ScacAndService/@ScacAndServiceKey")%>' />
		</td>
		<td class="detaillabel" nowrap="true" >
