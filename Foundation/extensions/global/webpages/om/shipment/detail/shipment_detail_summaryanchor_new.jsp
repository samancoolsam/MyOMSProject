...
if(elemShip != null){
	...
	if((equals("1100.70.06.30", elemShip.getAttribute("Status"))) && ( equals("Ready To Ship", resolveValue("xml:/Shipment/Status/@StatusName")) || equals("Ready To Ship", resolveValue("xml:/Order/Status/@StatusName"))  )&& (equals("701",resolveValue("xml:/Shipment/@ShipNode")) ||
equals("001",resolveValue("xml:/Shipment/@ShipNode")) || equals("711",resolveValue("xml:/Shipment/@ShipNode")))){
elemShip.setAttribute("UnpackFlag", true);

}
else {
elemShip.setAttribute("UnpackFlag", false);
}
