...
<%	if(equals("BUNDLE",resolveValue("xml:/ShipmentLines/ShipmentLine/@KitCode"))) {
		...
		YFCElement shipmentTemplate = YFCDocument.parse("<Shipment ShipmentHeaderKey=\"\"><ShipmentLines><ShipmentLine  ShipmentLineKey=\"\" ShipmentKey=\"\" ParentShipmentLineKey=\"\" KitCode=\"\" ItemID=\"\" ItemDesc=\"\" UnitOfMeasure=\"\" ProductClass=\"\" Quantity=\"\" WaveNo=\"\" KitQty=\"\" ></ShipmentLine></ShipmentLines></Shipment>").getDocumentElement();
		%>		
