	...
	<xsl:template match="Container">
		<PrintDocuments>
			...
			<xsl:attribute name="PrintName">
				<xsl:text>AcademySTOContainerLabel</xsl:text>
			</xsl:attribute>
			<PrintDocument>
		
			
			<xsl:attribute name="BeforeChildrenPrintDocumentId">
				<xsl:text>xml:/Containers/Container/@PrintDocumentId</xsl:text>
			</xsl:attribute>
			...
			<KeyAttributes>
				...
				<InputData>
					<xsl:attribute name="FlowName">
						<xsl:text>AcademyGetDataForSTOContainerLabel</xsl:text>
					</xsl:attribute>			
					<Container>				  
