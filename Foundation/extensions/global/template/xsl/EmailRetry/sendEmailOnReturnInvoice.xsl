...
<p><font size="2" face="Arial"><b>Dear <xsl:value-of select="/Order/PersonInfoBillTo/@FirstName"/>&#160;<xsl:value-of select="/Order/PersonInfoBillTo/@LastName"/> , </b></font> <br></br></p>
...
<tr valign="top"><td bgcolor="#EFEFEF" colspan="9" height="11"><font size="2" face="Arial"><b>Original Sales Order #: <xsl:value-of select="/Order/OrderLines/OrderLine/DerivedFromOrder/@OrderNo"/></b></font>
  </td></tr>
  <!-- Keeping it ready if asked for a change. All you have to do is just uncomment the below row! -->
   ...
   <xsl:variable name="receivedDate" select="/Order/@OrderDate"/>
   <font size="2" face="Arial"><b>Received : <xsl:value-of select="substring($receivedDate,6,2)"/>/<xsl:value-of select="substring($receivedDate,9,2)"/>/<xsl:value-of select="substring($receivedDate,0,5)"/></b></font>
  </td></tr>
...
<tr style="text-align:center" valign="top">
	<td width="60%" height="1" align="left"><br/><font size="2" face="Arial"><xsl:value-of select="ItemDetails/PrimaryInformation/@Description"/></font></td>
	<td width="10%" height="1"><br/><xsl:variable name = "derOrdLineKey" select = "@DerivedFromOrderLineKey" />
  	  	 <xsl:variable name = "orderUnit" select = "DerivedFromOrderLine[@OrderLineKey=$derOrdLineKey]/@OrderedQty" /> 
...
<tr style="text-align:center" valign="top">
	<!-- <td bgcolor="#3366CC" rowspan="2"><font color="#FFFFFF" size="2" face="Arial"><b>SUMMARY</b></font></td> -->
  	<td width="20%" bgcolor="#3366CC"><font color="#FFFFFF" size="2" face="Arial"><b>SUBTOTAL</b></font></td>
  	<td width="20%" bgcolor="#3366CC"><font color="#FFFFFF" size="2" face="Arial"><b>DISCOUNT</b></font></td>
  	<td width="20%" bgcolor="#3366CC"><font color="#FFFFFF" size="2" face="Arial"><b>SHIPPING</b></font></td>
  	<td width="20%" bgcolor="#3366CC"><font color="#FFFFFF" size="2" face="Arial"><b>TAX</b></font></td>
  	<td width="20%" bgcolor="#3366CC"><font color="#FFFFFF" size="2" face="Arial"><b>TOTAL</b></font></td>
  	<!-- <td colspan="4" bgcolor="#3366CC"><font color="#FFFFFF" size="2" face="Arial"><b>PAYMENT INFORMATION</b></font></td> -->
</tr>
<tr valign="top">
<td width="20%" align="center"><font color="#FF0000" size="2" face="Arial"><b>($<xsl:value-of select="/Order/OverallTotals/@LineSubTotal"/>)</b></font></td>
<td width="20%" align="center"><font size="2" face="Arial"><b>$<xsl:value-of select="/Order/OverallTotals/@GrandDiscount"/>
</b></font></td>
<td width="20%" align="center"><font color="#FF0000" size="2" face="Arial"><b>($<xsl:value-of select="/Order/OverallTotals/@GrandCharges"/>)</b></font></td>
<td width="20%" align="center"><font color="#FF0000" size="2" face="Arial"><b>($<xsl:value-of select="/Order/OverallTotals/@GrandTax"/>)</b></font></td>
<td width="20%" align="center"><font color="#FF0000" size="2" face="Arial"><b>($<xsl:value-of select="/Order/OverallTotals/@GrandTotal"/>)</b></font></td>  
<!-- <td colspan="4" align="center">
<xsl:for-each select = "/AcademyMergedDocument/EnvironmentDocument/Order/PaymentMethods/PaymentMethod">
<font size="2" face="Arial"><b>
	<xsl:if test = "@PaymentType='CREDIT_CARD'">Credit Card (<xsl:value-of select="@DisplayCreditCardNo"/>) 
...
<tr>
	...
	<xsl:for-each select = "/AcademyMergedDocument/EnvironmentDocument/Order/PaymentMethods/PaymentMethod">  
		...
		<b>		
		<xsl:if test = "@PaymentType='GIFT_CARD'">Gift Card (<xsl:value-of select="@SvcNo"/>) 
			$<xsl:value-of select="@TotalRefundedAmount"/>
		</xsl:if>
		</b>
		</font>
