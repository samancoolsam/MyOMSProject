<xsl:stylesheet
	...
	<xsl:output method="xml" indent="yes"
		cdata-section-elements="RFCPItemHTMLContent DelayedItemHTMLContent CancelledItemHTMLContent PendingItemHTMLContent" encoding="UTF-8"/>
...
<xsl:template match="/Order/ProductInfo/Delayed">
<xsl:copy>
        <xsl:copy-of select="*"/>
        <xsl:if test="not(DelayedItemHTMLContent)">
	<DelayedItemHTMLContent><xsl:if test="/Order/ProductInfo/Delayed/ItemInfo/@ItemID!= ''"><xsl:for-each select="/Order/ProductInfo/Delayed/ItemInfo"><xsl:variable name="OrderQty" select="./@OrderQty" /><xsl:variable name="ImageLoc" select="./@ImageLoc" /><xsl:variable name="ImageID" select="./@ImageID" /> <xsl:variable name="UnitPrice" select="./@UnitPrice" /><![CDATA[<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation"><tr><td height="20" style="height: 20px; font-size: 0; line-height: 1;"> </td></tr></table>
  ...
  <tr>
    ...
    <th valign="top" align="center" style="font-weight:normal;">
      <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td class="tablet-copy-16 mobile-copy-14" style="font-family: 'Hind', Arial, Helvetica, sans-serif; font-size: 20px; line-height: 20px; color: #4B4B4C; font-weight: 600; padding: 10px 15px 15px 0;">
            <a href="" target="_blank" title="Product" style="color: #4B4B4C; text-decoration: none;">]]><xsl:value-of select="./@Description"/><![CDATA[</a>
          </td>
        </tr>
        <tr>
          <td class="tablet-copy-14 mobile-copy-14" style="font-family: 'Hind', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 20px; color: #6A6A6A;">
        ...
        <tr>
          <td class="mobile-copy-18" style="font-family: 'Hind', Arial, Helvetica, sans-serif; font-size: 20px; line-height: 20px; color: #333333; font-weight: 600; padding: 15px 0;">
             $]]><xsl:value-of select="./@UnitPrice"/><![CDATA[</td>
        </tr>
      </table>
    </th>
  </tr>
</table>]]></xsl:for-each></xsl:if></DelayedItemHTMLContent>	
 </xsl:if>
    </xsl:copy> 	
 </xsl:template>   
  ...
  <tr>
    ...
    <th valign="top" align="center" style="font-weight:normal;">
      <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td class="tablet-copy-14 mobile-copy-14" style="font-family: 'Hind', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 20px; color: #6A6A6A; padding-top: 15px;">
            <span style="font-weight: bold; color: #333333;">ORDER QTY:</span> ]]><xsl:value-of
						select="format-number($OrderQty, '0')" /><![CDATA[
            <span style="font-weight: bold; color: #333333;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CANCEL QTY:</span> ]]><xsl:value-of
						select="format-number($CancelQty, '0')" /><![CDATA[</td>
        </tr>
      </table>
    </th>
  </tr>
...
<xsl:template match="/Order/ProductInfo/Pending">
	<xsl:copy>
		<xsl:copy-of select="*" />
		<xsl:if test="not(PendingItemHTMLContent)">
			<PendingItemHTMLContent>
				<xsl:if test="/Order/ProductInfo/Pending/ItemInfo/@ItemID!= ''">
					<xsl:for-each
						select="/Order/ProductInfo/Pending/ItemInfo">
          ...
          <td align="center" style="padding: 10px; border: 1px solid #cccccc;">
            <a href="" target="_blank" title="Product">
              <img src="]]><xsl:value-of
						select="concat($ImageLoc, $ImageID)" /><![CDATA[" width="116" alt="Product" border="0" style="display: block; max-width: 100%;"/>
            </a>
          </td>
        </tr>                                 
      </table>
    ...
    <th valign="top" align="center" style="font-weight:normal;">
      <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td class="tablet-copy-14 mobile-copy-14" style="font-family: 'Hind', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 20px; color: #6A6A6A;">
            <span style="font-weight: bold; color: #333333;">SKU:</span> ]]><xsl:value-of
						select="./@ItemID" /><![CDATA[
          </td>
        </tr>
        <tr>
          <td class="tablet-copy-14 mobile-copy-14" style="font-family: 'Hind', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 20px; color: #6A6A6A; padding-top: 15px;">
            <span style="font-weight: bold; color: #333333;">QTY:</span> ]]><xsl:value-of
						select="format-number($OrderQty, '0')" /><![CDATA[
          </td>
        </tr>
        <tr>
