                                        ...
                                        <xsl:for-each select="/Shipment/ShipmentLines/ShipmentLine">
                                            <tr valign="middle" style="text-align:center">
                                                <td height="35" style="text-align:left">
                                                    <font size="2" face="Arial">
                                                        <xsl:value-of select="./OrderLine/Item/@ItemDesc" />
										(<xsl:value-of select="./OrderLine/Item/@ItemID" />)
									</font>
                                                </td>
                                                <td>
                                                    <font size="2" face="Arial">
                                                        <xsl:value-of select="format-number(./OrderLine/@OriginalOrderedQty, '0')" />
                                                    </font>
                                                </td>
                                                <td>
                                                    <font size="2" face="Arial">
                                                        <xsl:choose>
                                                            ...
                                                            <xsl:otherwise>
                                                                <xsl:value-of select="format-number((./OrderLine/@OriginalOrderedQty)-(./OrderLine/@OrderedQty), '0')" />
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </font>
                                                </td>
