            ...
            <OrderShipping>
               <OrderStatusHeader Versioning="FALSE" UpdateMode="P">
                  <OrderNumber type="ByWCS">
				  	<xsl:value-of select="Shipment/ShipmentLines/ShipmentLine[1]/OrderLine/ChainedFromOrderLine/Order/@OrderNo" />
                  </OrderNumber>
               </OrderStatusHeader>
               ...
               <xsl:if test="@Quantity != 0.00">
					...
					<OrderStatusItem Versioning="FALSE">
						...
						<ItemNumber type="ByWCS">
							<xsl:value-of select="OrderLine/ChainedFromOrderLine/Extn/@ExtnWCOrderItemIdentifier" />
						</ItemNumber>
						...
						-->
						<Status StatusCondition="T" StatusFlag="I"></Status>
