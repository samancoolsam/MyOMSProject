    ...
    <xsl:element name="Adjustment">
        <xsl:element name="Inventory">
            ...
            <xsl:attribute name="ProductClass">
               <xsl:value-of select="ReceiptLines/ReceiptLine/@ProductClass"/>
            </xsl:attribute> 
            
            <xsl:attribute name="UnitOfMeasure">
               <xsl:value-of select="ReceiptLines/ReceiptLine/@UnitOfMeasure"/>
            </xsl:attribute>          
            ...
            <xsl:attribute name="ExtnTimeStamp">
             ...
             <xsl:attribute name="QuantityAdjusted">
               <xsl:value-of select="ReceiptLines/ReceiptLine/@UnreceiveQuantity"/>
            </xsl:attribute>
