...
cp -rf OMS_package/customer_overrides.properties.UAT700.95 /apps/SterlingOMS/Foundation/properties/customer_overrides.properties
cp -rf OMS_package/customer_overrides_agent.properties.UAT700.95 /apps/SterlingOMS/Foundation/properties/customer_overrides_agent.properties
